    ...
    for i, (train_idx, valid_idx) in enumerate(skf.split(dataset.image_paths, labels)):
        ...
        for epoch in range(args.epochs):
            ...
            with torch.no_grad():
                ...
                print()
        total_score['acc'].append(best_val_acc)
        total_score['loss'].append(best_val_loss)
    total_acc = sum(total_score['acc'])/n_splits
    total_loss = sum(total_score['loss'])/n_splits
    print(f'==============================================================/n')
    print(f'total_acc : {total_acc:4.2%}, total_loss : {total_loss:4.2%}')
    print(f'==============================================================')
    print()
